...
function initScrollTop() {
    ...
    function initImageCarousel() {
        ...
        const carouselImages = [
            { src: '../Lab4TWeb/img/img20.webp', caption: 'Balena albă cu cocoașă' },
            { src: '../Lab4TWeb/img/img22.jpg', caption: 'Balena albastră' },
            { src: '../Lab4TWeb/img/img21.jpg', caption: 'Balena în larg' },
            { src: '../Lab4TWeb/img/img1.jpg', caption: 'Orca - lupul mărilor' },
            { src: '../Lab4TWeb/img/img2.jpg', caption: 'Balena cu cocoașă sărind' },
            { src: '../Lab4TWeb/img/img3.jpg', caption: 'Balena albastră înotând' },
            { src: '../Lab4TWeb/img/img4.jpg', caption: 'Balena în apă' },
            { src: '../Lab4TWeb/img/img5.jpg', caption: 'Beluga - balena albă' },
            { src: '../Lab4TWeb/img/img6.avif', caption: 'Orca sărind' },
            { src: '../Lab4TWeb/img/img7.jpg', caption: 'Cașalotul' },
            { src: '../Lab4TWeb/img/img8.webp', caption: 'Narvalul - unicornul mării' },
            { src: '../Lab4TWeb/img/img9.jpg', caption: 'Beluga' },
            { src: '../Lab4TWeb/img/img10.webp', caption: 'Balena comună' },
            { src: '../Lab4TWeb/img/img11.jpg', caption: 'Balena minke' },
            { src: '../Lab4TWeb/img/img16.jpg', caption: 'Balena albastră' },
            { src: '../Lab4TWeb/img/img17.jpg', caption: 'Balena cu cocoașă' },
            { src: '../Lab4TWeb/img/img18.jpg', caption: 'Balena minke' },
            { src: '../Lab4TWeb/img/img19.jpg', caption: 'Cașalotul' },
            { src: '../Lab4TWeb/img/img23.jpg', caption: 'Balena albastră' },
            { src: '../Lab4TWeb/img/img24.jpg', caption: 'Balena cu cocoașă' },
            { src: '../Lab4TWeb/img/img25.jpg', caption: 'Balena albastră' },
            { src: '../Lab4TWeb/img/img26.jpg', caption: 'Balena cu cocoașă' },
            { src: '../Lab4TWeb/img/img27.webp', caption: 'Balena albastră și puiul ei' },
            { src: '../Lab4TWeb/img/img28.webp', caption: 'Orca' },
            { src: '../Lab4TWeb/img/img29.jpg', caption: 'Balena albă cu cocoașă și puiul ei' },
            { src: '../Lab4TWeb/img/img30.webp', caption: 'Balena cu cocoașă' },
            { src: '../Lab4TWeb/img/img31.jpg', caption: 'Balena albastră' },
            { src: '../Lab4TWeb/img/img32.jpg', caption: 'Balena minke' },
            { src: '../Lab4TWeb/img/img33.jpg', caption: 'Narvali' },
            { src: '../Lab4TWeb/img/img34.jpg', caption: 'Narvali' }
        ];
        ...
        btn.addEventListener('click', function() {
            ...
            setTimeout(() => {
                if (index < quizQuestions.length - 1) {
                    ...
                    let nume = localStorage.getItem('quizUserName');
                    if (!nume) {
                        nume = prompt('Completează-ți numele pentru a-ți salva rezultatul:', '');
                        if (nume && nume.trim() !== '') {
                            localStorage.setItem('quizUserName', nume);
                        } else {
                            nume = 'Anonim';
                        }
                    }
                    
                    // Trimite rezultatul la server
                    fetch('../php/salveaza_quiz.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded',
                        },
                        body: 'nume=' + encodeURIComponent(nume) + '&scor=' + score + '&total=' + quizQuestions.length
                    })
                    .then(response => response.json())
                    .then(data => {
                        if(data.success) {
                            console.log('Rezultat salvat:', data.message);
                        }
                    })
